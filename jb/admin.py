...
from jb.models import Part, StaffUser
...
class StaffUserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = StaffUser
        fields = ('email', 'password', 'date_of_birth', 'is_active', 'is_admin', 'slack_name', 'slack_hook', 'first_name', 'last_name')
...
class StaffUserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('date_of_birth',  'first_name', 'last_name', 'slack_name', 'slack_hook')}),
